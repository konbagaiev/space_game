...
export const SHIPS = [
  ...
  },
  {
    ...
    components: { hull: 2, engine: 6, thruster: 9 }, stats: { // light hull (30 hp) + scout engine/thrusters
      role: 'fighter', class: 'fighter', color: MARKER.small, reward: 25, xp: 25, dodge: 0, // xp = credit reward; dodge % (0 = always hit; future enemies may dodge)
  ...
  },
  {
    ...
    components: { hull: 2, engine: 6, thruster: 9 }, stats: { // same hull + engine + thrusters as the fighter
      role: 'rocketeer', class: 'fighter', color: MARKER.small, reward: 50, xp: 50, dodge: 0,
  ...
  },
  {
    ...
    components: { hull: 22, engine: 23, thruster: 33 }, stats: {
      role: 'pirate_gunner', class: 'fighter', color: MARKER.small, reward: 50, xp: 50, dodge: 0,
  ...
  },
  {
    ...
    components: { hull: 3, engine: 6, thruster: 10 }, stats: { // medium hull + scout engine + weak (Medium) thrusters
      role: 'medium', class: 'capital', color: MARKER.medium, reward: 125, xp: 125, dodge: 0,
  ...
  // side + two staggered rocket launchers.
  {
    ...
    components: { hull: 4, engine: 7, thruster: 11 }, stats: {
      role: 'boss', class: 'capital', color: MARKER.boss, reward: 250, xp: 250, dodge: 0,
  ...
  // --- Level-4 enemies (docs/plans/level-4-difficulty.md) ---
  {
    ...
    components: { hull: 24, engine: 6, thruster: 25 }, stats: {
      role: 'advanced_medium_pirate', class: 'capital', color: MARKER.medium, reward: 200, xp: 200, dodge: 0,
  ...
  },
  {
    ...
    components: { hull: 28, engine: 26, thruster: 27 }, stats: {
      role: 'boss2', class: 'capital', color: MARKER.boss, reward: 500, xp: 500, dodge: 0,
  ...
  },
  {
    ...
    components: { hull: 22, engine: 23, thruster: 32 }, stats: {
      role: 'advanced_rocket_pirate', class: 'fighter', color: MARKER.small, reward: 75, xp: 75, dodge: 0,
