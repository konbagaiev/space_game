...
// is one of the two ways a mission ends (`level-runner.checkArrival` → `canDock`; the "Finish and Return"
// button is the other, DECISIONS §132), so a headless World has to place it even though nothing here will
// ever draw it.
