...
6. **The mission list stays visible during the staged campaign-briefing reveal.** The `.briefing-hide-ship`
   ...
   like a broken list. Recorded as DECISIONS §97.
...
- **`docs/DECISIONS.md`** — add **§97** (§96 was taken by a parallel session; ours is §97) after §95, titled e.g.
  *"The Main Window right column is per-view content, not a permanent ship preview"*. Cover: (i) why the ship
  ...
  Take-off).
  Also append a short **"Amendment (§97, 2026-08-09)"** note to **§92** (`docs/DECISIONS.md:3278-3301`) — use
...
6. SUMMARY `**Updated:**` bumped, CHANGELOG bullet under `## 2026-08-09`, DECISIONS §97 added, §92 amended,
