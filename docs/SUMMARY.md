...
the first absorbed hit, so nothing new is SHOWN. DECISIONS §83 amended.) Previously: 2026-09-01 (**The Sentinel pilot fires as far as its gun fires, and shoots rockets out of the air** — the wingman and the duel
