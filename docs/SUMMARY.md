...
**Updated:** 2026-07-04 (**Convex-decomposition OBB ship hitboxes** — each real-model ship now collides as
...
wireframe overlay. Tight fit → bullets miss in the empty gap beyond a thin wing. Supersedes the same-branch
