...
> **Superseded for the distant BACKDROP half by §95** (the backdrop is now a player-locked wrapping
...
## 95. The parallax backdrop is a PLAYER-LOCKED WRAPPING POINT FIELD, not an origin-anchored rock ring
...
- **It is anchored to the origin.** The moment the player roams — and §94's cruise assist / star-system
  travel is exactly that direction — they fly *out* of the ring into genuinely empty space, i.e. the speed
