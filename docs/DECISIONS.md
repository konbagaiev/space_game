...
**Amendment (§96, 2026-08-09).** The first bullet is obsolete: the right-column ship preview (`mwPreview`,
...
## 96. The Main Window right column is per-view content, not a permanent ship preview
