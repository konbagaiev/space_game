...
// ---------- Audio settings modal moved to src/settings.js ----------
// The gear modal (volumes + quality tier + slide-to-confirm progress reset) is a self-contained leaf;
// its only outward tie is localizeSettings (imported here, called by the language switch below).
function takeOff() {
