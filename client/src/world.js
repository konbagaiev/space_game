...
// ~1.6M tris; DECISIONS §71 + §95). Load the pack ONCE per URL and hand back normalized VARIANTS: each geometry re-centered
...
// ---------- Player-locked wrapping speed field (the parallax backdrop; DECISIONS §95) ----------
...
export function buildMap(descriptor) {
  ...
  // Player-locked wrapping speed field (was: an origin-anchored asteroid ring — DECISIONS §95). The
